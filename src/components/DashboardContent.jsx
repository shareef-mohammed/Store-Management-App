...
const DashboardContent = () => {
    ...
    const openUserModal = () => {
      ...
      const openCoWorkerModal = () => {
        setIsCoWorkerOpen(true);
      };
    
      const closeCoWorkerModal = () => {
        setIsCoWorkerOpen(false);
      };
  return (
    <div className="w-full p-6 md:p-10">
      <div className="block md:flex justify-between">
        <motion.div
          onClick={openModal}
          className="flex items-center md:justify-start cursor-pointer justify-center bg-pink-300 w-full md:w-1/2 rounded-xl border h-40 md:m-4 m-0 md:mt-0 mt-4 shadow-lg"
          initial="hidden"
          whileInView="visible"
        ...
        <motion.div
          onClick={openCoWorkerModal}
          className="w-full flex md:justify-start justify-center cursor-pointer items-center bg-gray-300 md:w-1/2 rounded-xl border h-40 m-0 md:m-4 md:mt-0 mt-4 shadow-lg"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          transition={{ duration: 1 }}
        ...
        >
          ...
          <div>
            <p className="text-xl font-bold text-white">Add Co-Worker</p>
            <p className="text-white font-medium">Add a new Co-Worker</p>
          </div>
        </motion.div>
        <AddCoWorker isOpen={isCoWorkerOpen} onClose={closeCoWorkerModal} />
      </div>
      <div className="block md:flex justify-between">
        <motion.div
